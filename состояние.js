...
var DIRECTIONS = [
  {id:"pokoy",       c:"Calm",          t:"Покой",      d:"сбросить накал",                     href:"покой.html",      built:true, ic:"🌊", color:"#4e8a86"},
  {id:"interes",     c:"Curiosity",     t:"Интерес",    d:"хотеть, замечать, наполняться",      href:"интерес.html",    built:true, ic:"🔍", color:"#2f7d6b"},
  {id:"sochuvstvie", c:"Compassion",    t:"Сочувствие", d:"к себе, как к близкому",             href:"сочувствие.html", built:true, ic:"🤍", color:"#9197b1"},
  {id:"yasnost",     c:"Clarity",       t:"Ясность",    d:"видеть, что происходит",             href:"ясность.html",    built:true, ic:"🔭", color:"#274a5a"},
  {id:"smelost",     c:"Courage",       t:"Смелость",   d:"двинуться, не дожидаясь настроения", href:"смелость.html",   built:true, ic:"🔥", color:"#b98b3c"},
  {id:"uverennost",  c:"Confidence",    t:"Уверенность", d:"опереться на то, что уже выдержала", href:"уверенность.html", built:true, ic:"🗿", color:"#33474f"},
  {id:"tvorchestvo", c:"Creativity",    t:"Творчество", d:"выразить без слов",                  href:"творчество.html", built:true, ic:"🎨", color:"#7a5c17"},
  {id:"svyaz",       c:"Connectedness", t:"Связь",      d:"наружу, к людям",                    href:"связь.html",      built:true, ic:"🤝", color:"#454b6b"}
];
